		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Despachos",
									"targetURL": "#rizobacterdespachos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rizobacterdespachos-display": {
								"semanticObject": "rizobacterdespachos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rizobacter.despachos",
									"url": sap.ui.require.toUrl("rizobacter/despachos")
								}
							}
						}
					}
